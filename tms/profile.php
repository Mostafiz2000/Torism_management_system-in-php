...
<div class="banner ">
	...
	<div class="container">
		...
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;font-size:40px;color:white;">My Profile</h3>
...
<button type="submit" name="submit6" class="btn-primary btn">Update</button>
		 ...
		 <a class="btn-pass" href="change-password.php ">Change Passwrod</a>
	</div>
</div>
